              ...
              {Array.from({ length: 4 }).map((_, index) => (
                <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden p-4">
                  ...
                  <div className="mt-5 text-[#23396A] flex flex-col gap-5">
                    <h2 className=" font-semibold mb-2">Two Bedroom Studio Apartment</h2>
                    <div className="flex gap-2 items-center">
                      <CiLocationOn className='text-3xl' />
                      <p className='py-2 px-3 text-sm bg-[#F1F9FF] text-blue-600 font-semibold  w-20 flex items-center justify-center rounded-3xl'>Lagos</p>
                      <p className='py-2 px-3 text-sm bg-[#F1F9FF] text-blue-600 font-semibold  w-20 flex items-center justify-center rounded-3xl'>Lekki</p>
                    </div>
